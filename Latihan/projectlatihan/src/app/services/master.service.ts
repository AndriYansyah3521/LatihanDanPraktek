...
import { Datatablesrequest } from '../model/datatablesrequest.modul';
...
export class MasterService {
  ...
  getListKelasAll(parameter: Map<string, any>, datatablesParameters: any): Observable<DataTablesResponse> {
    ...
    console.log(dtReq);
    return this.htkl.post(environment.baseUrl + '/data', dtReq).pipe(map(data => data as DataTablesResponse));
  }
}